...
function FunctionalComponentUsingUseCase(){
    let initialState = {
        InstitutionName: " ",
        Cohort: " ",
        AdmissionYear: " ",
    ...
    return(
        <React.Fragment>
            ...
            <label htmlFor="Age">
                ...
                ge" id="Age" value={age} onChange={handleChange}/>
            </label><br/><br/>

            <label htmlFor="InstName">
                InstitutionName: <input type="text" name="InstitutionName" id="InstName" value={data.InstitutionName}
            ...
            <label htmlFor="AddMon">
                AdmissionMonth: <input type="text" name="AdmissionMonth" id="AddMon" value={data.AdmissionMonth} onChange={handleChange} />
            </label><br/><br/>

            <label htmlFor="AddYr">
                AdmissionYear: <input type="text" name="AdmissionYear" id="AddYr" value={data.AdmissionYear} onChange={handleChange} />
            </label><br/><br/>
        </React.Fragment>
    )
}
export default FunctionalComponentUsingUseCase